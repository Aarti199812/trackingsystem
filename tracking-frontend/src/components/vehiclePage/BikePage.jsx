...
const BikePage = () => {
  ...
  const vehicles = [
    { id: 1, name: '2 Wheeler', cap: '500kg', price: '160', img: 'https://nest-platform-assets.porter.in/2_wheeler_5624a12e03_cd20b2a174.svg' }, 
  ];

  const routes = [
    { to: "Karnal", kms: "80 Kms", price: "500" },
    { to: "Ambala", kms: "55 Kms", price: "100" },
    { to: "Chandigarh", kms: "95 Kms", price: "900" }
  ];
  ...
  return (
    <div className="booking-wrapper">
      ...
      <section className="vehicle-selection-area">
        <h2 className="section-title">Available 2 Wheelers in {selectedCity}</h2>
        <div className="vehicle-cards-flex">
          {vehicles.map((v, index) => (
            <div key={v.id} className="truck-card slide-up" style={{ animationDelay: `${index * 0.1}s` }}>
              ...
              <p>Base fare is inclusive of 1.0 km distance & 25 minutes of order time. </p>
